...
load_env() {
  ...
  CHEAT_SHEET_SYNC_ENABLED="${CHEAT_SHEET_SYNC_ENABLED:-true}"
  CHEAT_SHEET_SYNC_INTERVAL_HOURS="${CHEAT_SHEET_SYNC_INTERVAL_HOURS:-24}"
  CHEAT_SHEET_SYNC_SOURCE_URL="${CHEAT_SHEET_SYNC_SOURCE_URL:-https://banwagong1.com/claude-code.html}"
...
CHEAT_SHEET_SYNC_ENABLED=${CHEAT_SHEET_SYNC_ENABLED}
CHEAT_SHEET_SYNC_INTERVAL_HOURS=${CHEAT_SHEET_SYNC_INTERVAL_HOURS}
CHEAT_SHEET_SYNC_SOURCE_URL=${CHEAT_SHEET_SYNC_SOURCE_URL}
EOF
